      ...
      {isDeleteModalOpen && (
        <div className="modal modal-open">
          <div className="modal-box">
            ...
            <p className="py-4">Êtes-vous sûr de vouloir supprimer ce secteur ? Cette action est irréversible.</p>
            <div className="modal-action">
              <button onClick={handleDeleteCancel} className="btn">Annuler</button>
              <button onClick={handleDeleteConfirm} className="btn btn-error">Supprimer</button>
            </div>
          </div>
        </div>
      )}
