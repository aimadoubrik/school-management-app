        ...
        <div className="min-h-screen bg-base-100">
            ...
            <div className="absolute z-50 p-4 text-white bg-transparent md:p-7 navbar">
                ...
                <div className="navbar-end">
                    <Link to="/login" className="rounded-full btn btn-primary">Get Started</Link>
                </div>
            </div>

            {/* Hero Section */}
            <div className="min-h-screen hero" style={{
                backgroundImage: 'url("https://laquotidienne.ma/uploads/actualites/632586ddcef40_ofppt.jpeg")',
                ...
                <div className="text-center hero-content text-neutral-content">
                    <div className="max-w-2xl px-4">
                        ...
                        <p className="mb-5 text-lg md:text-xl">
                            Revolutionize educational administration with our intelligent, user-friendly platform designed to simplify complex school operations.
                        </p>
            ...
            <div id='features' className="py-16 bg-base-200">
                <div className="container px-4 mx-auto">
                    <h2 className="mb-12 text-3xl font-bold text-center md:text-4xl">Comprehensive School Solutions</h2>
                        ...
                        {[
                            {
                                ...
                                description: 'Our platform is designed to be intuitive and easy to use for all stakeholders.'
                            },
                            {
                                title: 'Advanced Automation',
                                description: 'Automate repetitive tasks and streamline complex processes for efficiency.'
                            },
                            {
                                title: 'Real-Time Insights',
                                description: 'Gain real-time visibility into student performance and school operations.'
                            },
                            {
                                title: 'Scalability and Flexibility',
                                description: 'Our platform can grow with your institution and adapt to changing needs.'
                            }
