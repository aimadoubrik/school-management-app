...
const Docs = () => {
    ...
    const getGroupsForFiliere = (filiere) => 
        [...new Set(stagiaires
            .filter(s => s.LibelleLong === filiere)
            .map(s => s.CodeDiplome)
        )];

    const getStagiairesByGroup = (group) => 
        stagiaires.filter(s => s.CodeDiplome === group);
        ...
        <div className="form-control w-full gap-4">
            ...
            <div className="form-control">
                ...
                >
                    ...
                    {form.filiere && getGroupsForFiliere(form.filiere).map((group, index) => (
            ...
            {form.printType === "individuel" && (
                <div className="form-control">
                    ...
                    <select
                        ...
                        onChange={(e) => {
                            const selectedStagiaire = stagiaires.find(s => s.MatriculeEtudiant === e.target.value);
                    ...
                    >
                        ...
                        {form.group && getStagiairesByGroup(form.group).map((stagiaire, index) => (
