...
const ThemeToggle = () => {
  ...
  return (
    <div 
      className="btn btn-ghost cursor-pointer flex items-center justify-center" 
      onClick={handleThemeToggle}
    >
      <label 
        className="swap swap-rotate cursor-pointer flex items-center justify-center" 
        onClick={handleThemeToggle}
      >
        {/* Icône SVG (cliquable) */}
        <svg
          className="h-6 w-6 fill-current cursor-pointer pointer-events-auto"
